...
import (
	...
	"github.com/freetsdb/freetsdb/cmd/freetsd_ctl/backup"
	"github.com/freetsdb/freetsdb/cmd/freetsd_ctl/help"
	"github.com/freetsdb/freetsdb/cmd/freetsd_ctl/node"
	"github.com/freetsdb/freetsdb/cmd/freetsd_ctl/restore"
)
...
func (m *Main) Run(args ...string) error {
	...
	default:
		return fmt.Errorf(`unknown command "%s"`+"\n"+`Run 'freetsd_ctl help' for usage`+"\n\n", name)
	}

	return nil
}

// VersionCommand represents the command executed by "freetsd_ctl version".
